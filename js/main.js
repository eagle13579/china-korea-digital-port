...
const translations = {
    'zh-CN': {
        ...
        features_title: '数字员工',
        features_subtitle: '利用专业数字员工，为企业跨境发展提供智能解决方案',
    ...
    'ko-KR': {
        ...
        features_title: '디지털 직원',
        features_subtitle: '전문 디지털 직원을 활용하여 기업의 해외 진출을 위한 지능형 솔루션 제공',
    ...
    'en': {
        ...
        about: 'About Us',
        services: 'Services',
        features: 'Digital Employees',
        home: 'Home',
        team_nav: 'Digital Employees',
        ...
        features_title: 'Digital Employees',
        ...
        features_subtitle: 'Leveraging professional digital employees to provide intelligent solutions for cross-border business growth',
